...
# Note: the legacy 'RandomProjetion' typo spelling is no longer accepted; current branch's
# canonical-spelling commit (e444ea34a) requires 'RandomProjection'.
...
def test_run_snapshot_on_3d_input_returns_spatial_sensors():
    pp = SparseSensing()
    pp.name = 'spsl'
    pp.sparseSensingGoal = 'reconstruction'
