...
"""
  Testing for the ScrambleMutator method
...
uniformDiscreteElement.append(createElement("upperBound",text="5.0"))
...
kwargs = {'locs': [1,3], 'mutationProb': 1.0, 'variables': ['x1', 'x2', 'x3', 'x4']}

scrambleMutator = returnInstance('tester', 'scrambleMutator')

children = scrambleMutator(population, distDict, **kwargs)
