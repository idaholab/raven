...
poissonCdf1 = poisson.cdf(1.0)
poissonCdf5 = poisson.cdf(5.0)
poissonCdf10 = poisson.cdf(10.0)
ppoissonCdf1 = ppoisson.cdf(1.0)
ppoissonCdf5 = ppoisson.cdf(5.0)
ppoissonCdf10 = ppoisson.cdf(10.0)

checkAnswer("poisson ppf(cdf(1.0))",poisson.ppf(poissonCdf1),1.0)
checkAnswer("poisson ppf(cdf(5.0))",poisson.ppf(poissonCdf5),5.0)
checkAnswer("poisson ppf(cdf(10.0))",poisson.ppf(poissonCdf10),10.0)
checkAnswer("ppoisson ppf(cdf(1.0))",ppoisson.ppf(ppoissonCdf1),1.0)
checkAnswer("ppoisson ppf(cdf(5.0))",ppoisson.ppf(ppoissonCdf5),5.0)
checkAnswer("ppoisson ppf(cdf(10.0))",ppoisson.ppf(ppoissonCdf10),10.0)
