...
def run(self, Input):
  global localLock
  self.initialTemperatures[0]  = self.anAliasForLeftTemperatureInHeatTransfer  # one boundary condition
  self.initialTemperatures[-1] = self.anAliasForRightTemperatureInHeatTransferr # the other boundary condition
  with localLock:
