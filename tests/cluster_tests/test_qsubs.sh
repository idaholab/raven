...
python ../../framework/Driver.py test_mpiqsub_local_memory_requested.xml pbspro_mpi.xml cluster_runinfo.xml

wait_lines 'FirstMQRun/[1-6]/*test.csv' 6 mpiqsubmemory
