...
[Functions]
  ...
  [../]
  [./pressure_ramp]
    # reads and interpolates input data defining amplitude curve for fill gas pressure
    y =  '0 1'
    x =  '-200 0'
...
[Kernels]
  ...
  [./gravity]
    # body force term in stress equilibrium equation
    variable =  disp_y
    type =  Gravity
    value =  -9.81
  [../]
...
[CoolantChannel]
  [./convective_clad_surface]
    # apply convective boundary to clad outer surface
...
[Materials]
  ...
  [./fuel_solid_mechanics_swelling]
    # free expansion strains (swelling and densification) for UO2 (bison kernel)
    burnup =  burnup
    type =  VSwellingUO2
    temp =  temp
    block =  pellet_type_2
  ...
  [./fission_gas_release]
    ...
    initial_grain_radius = 8.10314680958e-06
    gbs_model =  true
    type =  Sifgrs
    block =  pellet_type_2
  [../]
...
[Postprocessors]
  ...
  [../]
  [./fis_gas_produced]
    # fission gas produced (moles)
    variable =  temp
    type =  ElementIntegralFisGasGeneratedSifgrs
    block =  pellet_type_2
  [../]
  [./fis_gas_released]
    # fission gas released to plenum (moles)
    variable =  temp
  ...
  [../]
  [./plenum_pressure]
    # pressure within plenum and gap
    type =  Reporter
  [../]
  [./initial_moles]
    # initial fill gas mass (moles)
    output =  file
    type =  Reporter
  [../]
  [./flux_from_clad]
  ...
  [./max_stress]
    ...
    block =  clad
  [../]
  [./Materials|fission_gas_release|initial_grain_radius]
    default = 8.10314680958e-06
    type = Reporter
  [../]
  [./Materials|clad_solid_mechanics|clad_solid_mechanics|youngs_modulus]
    default = 12957926238.7
    type = Reporter
  [../]
  [./Functions|power_history|scale_factor]
    default = 1.03646689945
    type = Reporter
  [../]
[]
[Output]
