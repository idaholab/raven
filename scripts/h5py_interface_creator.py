...
class hdf5Database:
    ...
    def __addGroupRootLevel(self,gname,attributes,source):
      ...
      if source['type'] == 'csv':
        ...
        grp.attrs["distDict"]   = None #TODO
        grp.attrs["poly_ords"]  = None #TODO
        grp.attrs["qps"]        = None #TODO
        grp.attrs["wts"]        = None #TODO

#TODO I think this is where I need to add distDict to pass through
# --> exp order tuple, prob norm product,stToActualWeight product, evNormPoly,
#     revertPoly values for given order expansion
        try:
