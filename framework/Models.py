...
class Dummy(Model):
  ...
  def createNewInput(self,myInput,samplerType,**Kwargs):
    ...
    if not any(inputDict.values()): self.raiseAnError(IOError,'While preparing the input for the model '+self.type+' with name '+self.name+' found an None input variable '+ str(inputDict.items()))
