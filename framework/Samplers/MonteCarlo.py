...
class MonteCarlo(ForwardSampler):
  ...
  def localGenerateInput(self, model, myInput):
    ...
    for key in self.distDict:
      ...
      # in this case, the user wants to sample the comma separated variables with the same sampled value => link the
      # value to all comma separated variables
    ...
    if self.samplingType == 'uniform':
      ...
      # MC weight is 1/N => weight is one
