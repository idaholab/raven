...
#    print('Graph Preparation: %f s' % (end-start))
    ...
    for i in xrange(0,self.__amsc.Size()):
      ...
      line += sep + str(self.__amsc.MinLabel(i,self.persistence))
      line += sep + str(self.__amsc.MaxLabel(i,self.persistence))
      outputDict['minLabel'][i] = self.__amsc.MinLabel(i,self.persistence)
      outputDict['maxLabel'][i] = self.__amsc.MaxLabel(i,self.persistence)
      print(line)
