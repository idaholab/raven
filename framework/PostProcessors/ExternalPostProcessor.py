...
class ExternalPostProcessor(PostProcessor):
  ...
  def __init__(self, messageHandler):
    ...
    # A list of strings specifying what
    self.methodsToRun = []
    # methods the user wants to compute from
    # the external interfaces

    # A set of Function objects that
    self.externalInterfaces = set()
  ...
  def run(self, inputIn):
    ...
    # TODO: We assume the structure of input to the external pp is the same as the struture of output to this
    # external pp
    # An interface pp should be used if the user wants to merge two data objects, or change the structures of input
    # data
    # objects.
