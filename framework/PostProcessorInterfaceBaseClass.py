...
class PostProcessorInterfaceBase(
    utils.metaclass_insert(abc.ABCMeta, object), MessageHandler.MessageUser):
  """
  ...
  def initialize(self):
    """
      ...
      These two variables check that the input and output dictionaries match what PP is supposed to receive and
      generate
  ...
  def checkOutputFormat(self, outputDic):
    """
      This method checks that the generated output part of the generated dictionary is built accordingly to
      outputFormat
      @ In, outputDic, dict, dictionary generated by the run method
  ...
  def checkInputFormat(self, outputDic):
    """
      This method checks that the generated input part of the generated dictionary is built accordingly to
      outputFormat
      @ In, outputDic, dict, dictionary generated by the run method
      @ Out, outcome, bool, outcome of the outputDic check (True/False)
    """
