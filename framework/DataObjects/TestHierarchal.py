...
checkArray('Path early paths[0]',paths[0],['1','3'],str)
checkArray('Path early paths[1]',paths[1],['1','2','4'],str)
full = data._constructHierPaths()
checkArray('Path early full[0] RSID',full[0]['RAVEN_sample_ID'].values,[0,2],float)
checkArray('Path early full[1] RSID',full[1]['RAVEN_sample_ID'].values,[0,1,3],float)
checkArray('Path early full[0] prefix',full[0]['prefix'],['1','3'],str)
checkArray('Path early full[1] prefix',full[1]['prefix'],['1','2','4'],str)
checkArray('Path full[0] a',full[0]['a'].values,[1,2],float)
checkArray('Path full[1] a',full[1]['a'].values,[1,1,1],float)

# add more realizations, and test contents
...
checkArray('Path full[0] prefix',full[0]['prefix'],['1','2','4'],str)
checkArray('Path full[1] prefix',full[1]['prefix'],['1','2','5'],str)
checkArray('Path full[2] prefix',full[2]['prefix'],['1','3','6'],str)
checkArray('Path full[3] prefix',full[3]['prefix'],['1','3','7'],str)
