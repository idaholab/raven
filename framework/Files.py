...
class File(BaseType):
  ...
  def __init__(self):
    ...
    # when open, refers to open file, else None
    self.__file = None
    # file path
    self.__path = ''
    # file base
    ...
    # type ("type" in the input) to label a file to any particular subcode in the code interface
    self.type = None
    # is this file perturbable by a sampling strategy?
  ...
  def open(self, mode='rw'):
    """
      ...
      @ In, mode, string, optional, the read-write mode according to python "file" method ('r','a','w','rw',etc)
             (default 'rw')
      @ Out, None
    """
    if not self.isOpen():
...
class StaticXMLOutput(RAVENGenerated):
  ...
  def addVector(self,
    ...
    """
      ...
      @ In, valueAttrsDict, dict, optional, dictionary of attributes to be stored along the subnodes identified by
             the valueDict dictionary
      @ Out, None
    """
    valAttribsDict = {}
...
class DynamicXMLOutput(StaticXMLOutput):
  ...
  def __init__(self):
    ...
    self.pivotNodes = []
    # RBTree (self maintained) of unique pivot values
    self.pivotVals = []
  ...
  def addVector(self,
    ...
    """
      ...
      @ In, valueAttrsDict, dict of dict, optional, dictionary of attributes (dict) to be stored along the subnodes
...
class UserGenerated(File):
  ...
  def _readMoreXML(self, node):
    """
      ...
      @ Out, None
    """
    # XSD should confirm valid types
