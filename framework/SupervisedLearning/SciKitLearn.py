...
class SciKitLearn(supervisedLearning):
  ...
  def __init__(self, **kwargs):
    ...
    if len(self.availImpl) == 0:
      ...
      #Not Applicable: self.availImpl['neighbors']['BallTree'                       ] = (sklearn.neighbors.BallTree                       , 'float' ,  True )# BallTree for fast generalized N-point problems
      #Not Applicable: self.availImpl['neighbors']['KDTree'                         ] = (sklearn.neighbors.KDTree                         , 'float' ,  True )# KDTree for fast generalized N-point problems
