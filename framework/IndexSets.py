...
class IndexSet(MessageHandler.MessageUser):
  ...
  def __init__(self, messageHandler):
    ...
    # maximum requested polynomial order requested for each distribution
    self.maxOrds = None
    # array of polynomial order tuples
    self.points = []
    # integer, maximum order polynomial to use in any one dimension -> misleading! Relative order for anisotropic case
  ...
  def __eq__(self, other):
    ...
    """
    isEqual = self.type == other.type and self.points == other.points and (
