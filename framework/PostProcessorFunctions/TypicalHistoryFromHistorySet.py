...
#     print(inputDict['output'].keys())   
    ...
    outputDict ={'data':{'input':{},'output':{}}, 'metadata':{0:{}}}
    outputDict['data']['output'][1] = typicalTS    
    keyH = inputDict['input'].keys()[0] 
    outputDict['data']['input'][1] = {}
    for keyIn in inputDict['input'][keyH].keys():
      outputDict['data']['input'][1][keyIn] = np.array(inputDict['input'][keyH][keyIn][0])
