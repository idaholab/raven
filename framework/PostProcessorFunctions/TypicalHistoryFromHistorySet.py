...
class TypicalHistoryFromHistorySet(PostProcessorInterfaceBase):
  ...
  def run(self,inputDic):
    ...
    #identify features
    self.features = inputDict['outVars']# self.features = inputDict['output'][inputDict['output'].keys()[0]].keys()
    ...
    referenceHistory = 0 # inputDict['output'].keys()[0]
    ...
    for historyNumber in range(inputDic['numberRealizations']):  #inputDict['output'].keys():
