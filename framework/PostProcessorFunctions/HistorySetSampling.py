...
class HistorySetSampling(PostProcessorInterfaceBase):
  ...
  def varsTimeInterp(self, vars):
    """
      ...
      @ In, vars, dict, data set that contained the information of the multi-variate temporal function (this is
...
def timeSeriesFilter(pivotParameter, vars, filterType, filterValue):
  ...
  pivotParameter      : the ID of the temporal variable
    ...
    samplingType: type of sampling used to determine the coordinate of the numSamples samples ('firstDerivative',
    'secondDerivative')
