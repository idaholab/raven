...
class riskMeasuresDiscrete(PostProcessorInterfaceBase):
  ...
  def runDynamic(self,inputDic,timeHistory):
    """
     This method perform the dynamic calculation of the risk measures
     @ In, inputDic, list, list of dictionaries which contains the data inside the input DataObjects
     @ In, timeHistory, dict, dictionary containing  boolean temporal profiles (0 or 1) of a sub set of the input variables
     @ Out, outputDic, dict, dictionary which contains the risk measures
    """
