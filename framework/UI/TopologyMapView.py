...
class CustomPathItem(qtw.QGraphicsPathItem):
  ...
  def __init__(self, path, parent=None, scene=None, data=None):
    ...
    # contextual pop-up text
    cKey = qtg.QPainterPath()
...
class TopologyMapView(BaseTopologicalView):
  ...
  def test(self):
    ...
    # self.mouseMoveEvent(qtg.QMouseEvent(qtc.Qt.MouseButton), qtc.QPoint(0,0), None, qtc.QEvent.Type,
    # qtc.QPoint(0,0), qtc.Qt.)
    self.updateScene()
