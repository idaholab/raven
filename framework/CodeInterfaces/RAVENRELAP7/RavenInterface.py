...
class RavenInterface:
  ...
  def createNewInput(self,currentInputFiles,oriInputFiles,samplerType,**Kwargs):
    ...
    MOOSEparser = imp.load_module('MOOSEparser',os.path.join(uppath(os.getcwd(),1),'MooseBasedApp')+'MOOSEparser.py')
  ...
  def __genBasePointSampler(self,**Kwargs):
    ...
    for key in distributionKeys:
      ...
      distributions[key] = [Kwargs["SampledVars"].pop(key),distributionName,
                            distributionType]
    mooseInterface = imp.load_module('MooseBasedAppInterface',os.path.join(uppath(os.getcwd(),1),'MooseBasedApp')+'MooseBasedAppInterface.py')
