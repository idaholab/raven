...
class ROM(Dummy):
  ...
  def getInputSpecification(cls):
    ...
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("compute_score", InputData.StringType))
    inputSpecification.addSub(
        InputData.parameterInputFactory("threshold_lambda",
                                        InputData.FloatType))
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("fit_intercept", InputData.StringType))
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("normalize", InputData.StringType))
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("verbose", InputData.StringType))
    inputSpecification.addSub(
    ...
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("warm_start", InputData.StringType))
    # bool?
    inputSpecification.addSub(
        InputData.parameterInputFactory("positive", InputData.StringType))
    inputSpecification.addSub(
    ...
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("fit_path", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("penalty", InputData.StringType))
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("dual", InputData.StringType))
    inputSpecification.addSub(
    ...
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("shuffle", InputData.StringType))
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("loss", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("solver", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("gcv_mode", InputData.StringType))
    # bool
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("learning_rate", InputData.StringType))
    inputSpecification.addSub(
    ...
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("probability", InputData.StringType))
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("shrinking", InputData.StringType))
    inputSpecification.addSub(
    ...
    # bool
    inputSpecification.addSub(
        InputData.parameterInputFactory("fit_prior", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("weights", InputData.StringType))
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("algorithm", InputData.StringType))
    inputSpecification.addSub(
        InputData.parameterInputFactory("leaf_size", InputData.IntegerType))
    # enum?
    inputSpecification.addSub(
        InputData.parameterInputFactory("metric", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("splitter", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("regr", InputData.StringType))
    # enum?
    inputSpecification.addSub(
        InputData.parameterInputFactory("corr", InputData.StringType))
    inputSpecification.addSub(
        InputData.parameterInputFactory("beta0", InputData.StringType))
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("storage_mode", InputData.StringType))
    inputSpecification.addSub(
    ...
    # enum
    inputSpecification.addSub(
        InputData.parameterInputFactory("optimizer", InputData.StringType))
    inputSpecification.addSub(
  ...
  def __init__(self, runInfoDict):
    ...
    # ROM initialization options
    self.initializationOptionDict = {}
    # boolean flag, is the ROM trained?
  ...
  def train(self, trainingSet):
    """
      ...
      @ In, trainingSet, dict or PointSet or HistorySet, data used to train the ROM; if an HistorySet is provided
             the a list of ROM is created in order to create a temporal-ROM
      @ Out, None
    """
  ...
  def confidence(self, request, target=None):
    """
      ...
      @ Out, confidenceDict, dict, the dict containing the confidence on each target ({'target1':np.array(size 1 or
             n_ts),'target2':np.array(...)}
    """
  ...
  def evaluate(self, request):
    """
      When the ROM is used directly without need of having the sampler passing in the new values evaluate instead of
      run should be used
      @ In, request, datatype, feature coordinates (request)
      @ Out, outputEvaluation, dict, the dict containing the outputs for each target ({'target1':np.array(size 1 or
             n_ts),'target2':np.array(...)}
    """
    inputToROM = self._inputToInternal(request)
  ...
  def _externalRun(self, inRun):
    """
      Method that performs the actual run of the imported external model (separated from run method for
