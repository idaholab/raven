...
%
\begin{itemize}
  \item \xmlNode{transition}, \xmlDesc{float, required field}, the transition matrix
  \item \xmlNode{dataFile}, \xmlDesc{string, required xml node}. The path for the given data file, i.e. the transition matrix.
