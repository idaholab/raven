...
{The user needs to be able to see the progress of the algorithms, and what the results are graphically.  As well, plots to be used in documentation need to be outputted.  The plotting capability of RAVEN is used for this.}
