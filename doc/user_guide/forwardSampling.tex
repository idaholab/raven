...
\begin{enumerate}
 ...
 \begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{../../tests/framework/user_guide/ForwardSamplingStrategies/gold/RunDir/MonteCarlo/1-samplesPlot3D_scatter-scatter-scatter-scatter.svg}
...
\begin{enumerate}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 %figure sparse grid rom validation
 %\begin{figure}[h!]
 % \centering
 % \includegraphics[scale=0.7]{pics/SparseGrid_histories.png}
 % \caption{Plot of the verification samples on Code generated by Monte Carlo sampling for variables $A,B,C,D$.}
 % \label{fig:historiesSparseGridPlotLine}
 %\end{figure}
 %\begin{figure}[h!]
 % \centering
 % \includegraphics[scale=0.7]{pics/SparseGrid_histories.png}
 % \caption{Plot of the verification samples on ROM generated by Monte Carlo sampling for variables $A,B,C,D$.}
 % \label{fig:historiesSparseGridPlotLine}
 %\end{figure}
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
