...
a dedicated object (named ``\textbf{Entity}''). Each object is inactive unttil it is connected with 
other objects in order to perform a more complex process. For example,
the \textit{Sampler} entity, designed to perform a perturbation action, becomes active only in case
