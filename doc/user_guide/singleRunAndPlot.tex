...
\end{enumerate}
 ...
 \begin{table}[h!]
   ...
   ]{../../tests/framework/user_guide/SingleRuns/gold/sectionVI.I/history_0.csv}
 \end{table}
 \begin{table}[h!]
   \centering
   ...
   \pgfplotstabletypeset[col sep=comma,
     every head row/.style={after row={\hline}}
   ]{../../tests/framework/user_guide/SingleRuns/gold/sectionVI.I/pointValues.csv}
 \end{table}
