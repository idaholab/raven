...
\begin{enumerate}
   \item \textbf{Set up the running environment}: \xmlNode{RunInfo}
     \\The \textbf{RunInfo} entity is an information container which describes how the overall computation should
      ...
      \xmlExample{framework/user_guide/SingleRuns/singleRun.xml}{RunInfo}
   ...
   \item \textbf{Provide the required files}: \xmlNode{Files}
     ...
     will look like:
     \xmlExample{framework/user_guide/SingleRuns/singleRun.xml}{Files}
   ...
   \item \textbf{Link between RAVEN and driven code}: \xmlNode{Models}
     ...
     \xmlExample{framework/user_guide/SingleRuns/singleRun.xml}{Models}
   ...
   \item \textbf{Container of input and output data}: \xmlNode{DataObjects}
     ...
     \xmlExample{framework/user_guide/SingleRuns/singleRun.xml}{DataObjects}
    ...
    \item \textbf{Print and plot input and output data}: \xmlNode{OutStreams}
      ...
      \xmlExample{framework/user_guide/SingleRuns/singleRun.xml}{OutStreams}
    ...
    \item \textbf{Control of executions}: \xmlNode{Steps}
      ...
      of a model.
      \xmlExample{framework/user_guide/SingleRuns/singleRun.xml}{Steps}
...
\textit{OutStreams}. The \xmlNode{IOStep} block is shown as following:
\xmlExample{framework/user_guide/SingleRuns/singleRunPlotAndPrint.xml}{Steps}
\xmlExample{framework/user_guide/SingleRuns/singleRunPlotAndPrint.xml}{DataObjects}
...
\xmlExample{framework/user_guide/SingleRuns/singleRunSubPlotsAndSelectivePrint.xml}{Steps}
