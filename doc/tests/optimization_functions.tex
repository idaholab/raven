...
\subsubsection{Diagonal Valley}
The three-dimensional diagonal valley offers a low region surrounded by higher walls.

\begin{itemize}
  \item Function: $f(x,y) =  (x+0.5)^2 + (y-0.5)^2 + \sqrt{(x - \cfrac{x}{x-y})^2 + (y - \cfrac{y}{y-x})*^2} * 10$
