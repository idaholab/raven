...
\begin{lstlisting}[style=XML,morekeywords={subType}]
  ...
  ...
    <PostProcessor name="pp1" subType="Representativity">
      <prototypeOutputs>outputDataMC1|F1, outputDataMC1|F2, outputDataMC1|F3</prototypeOutputs>
      <targetOutputs>outputDataMC2|F1, outputDataMC2|F2, outputDataMC2|F3</targetOutputs>
      <prototypeParameters>outputDataMC1|p1,outputDataMC1|p2</prototypeParameters>
