...
\begin{itemize}
  ...
  \item \xmlNode{random\_state}, \xmlDesc{integer, optional field}, when shuffle=True,
    pseudo-random number generator state used for shuffling. If not present, use default numpy RNG for shuffling. \textbf{Note that}, if shuffle is False and random\_state is present, sklearn will error out.
\end{itemize}
...
\begin{itemize}
  ...
  \item \xmlNode{random\_state}, \xmlDesc{integer, optional field}, when shuffle=True,
    ...
    \textbf{Note that}, if shuffle is False and random\_state is present, sklearn will error out.
\end{itemize}
