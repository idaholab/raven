...
\begin{itemize}
\item \xmlNode{Goal}, \xmlDesc{[reconstruction]}, the goal of the sparse sensor optimization (i.e., reconstruction or classification) should be filled in subType.
\item \xmlNode{TrainingData}, \xmlDesc{string, required field}, the Dataobject containing the training data
...
\item \xmlNode{basis} , \xmlDesc{[Identity, SCVD, Random]}, the type of basis onto which the data are projected. 
...
\item \xmlNode{optimizer},  \xmlDesc{[QR, CCQR]}.
\end{itemize}
