...
outcome(s) in a ``\textbf{DataObjects}'' object of type \textbf{TimePoint} or 
...
\begin{itemize}
  \item \xmlAttr{class}, \xmlDesc{required string attribute}, main object class
    ...
    This string corresponds to the tag of the main object's type used in the
    input.
    The allowable main classes are \xmlString{DataObjects}, \xmlString{Databases}, \xmlString{OutStreamManager}, \xmlString{Models} and \xmlString{Files}.
  \item \xmlAttr{type}, \xmlDesc{required string attribute}, the actual entity
    type.
    This attribute specifies the object type within the main object class.
...
<Steps>
  ...
  <IOStep name='OutStreamStep'>
    <Input class='DataObjects' type='Histories'>aHistories</Input>
    <Input class='DataObjects' type='TimePointSet'>aTPS</Input>
  ...
  <IOStep name='ConstructDataObjectsFromDatabase'>
    ...
    <Input class='Databases' type='HDF5'>aDatabase</Input>
    <Output class='DataObjects'    type='Histories'>aHistories</Output>
    <Output class='DataObjects'    type='TimePointSet'>aTPS</Output>
  </IOStep>
...
<Steps>
  ...
  <PostProcess name='PP1'>
      <Input  class='DataObjects'  type='TimePointSet' >aData</Input>
