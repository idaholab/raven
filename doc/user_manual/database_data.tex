...
%    \default{random seed};
  ...
  \item \xmlAttr{historyName}, \xmlDesc{optional string attribute}, in the case  the 
   ``DataObject'' type is either a \textit{Point} or a
  \textit{History}, this XML node contains the name of the associated history needs to be placed in.
  \\\nb This attribute is a required parameter when the  \textit{Point} or \textit{History}
...
<DataObjects>
  <Point name='TP' inputTs='-1' operator='max' hierarchical='False' historyName='a_history_name'>
