...
\begin{itemize}
   \item \xmlNode{pivotParameter}, \xmlDesc{string, optional field}, used to
       specify  the name of the independent dimension (e.g. time) used in the  \xmlNode{HistorySet}. By default,
       the pivotParameter is set to \textbf{``time''};
