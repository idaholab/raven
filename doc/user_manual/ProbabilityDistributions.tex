...
\subnodeIntro
\begin{itemize}
  \item \xmlNode{state 1}, \xmlDesc{float, required parameter}, probability for state 1
  \item \xmlNode{state 2}, \xmlDesc{float, required parameter}, probability for state 2
  \item ...
  \item \xmlNode{state K}, \xmlDesc{float, required parameter}, probability for state K
 \end{itemize}
Example:
\begin{lstlisting}[style=XML]
<Distributions>
