...
\label{Beta}
The \distname{Beta} distribution is a continuous distribution defined on the
...
\label{Exponential}
The \distname{Exponential} distribution is a continuous distribution that can be
...
\label{Logistic}
The \distname{Logistic} distribution is a continuous distribution similar to the
...
\label{LogNormal}
The \distname{LogNormal} distribution is a continuous distribution with the
...
\label{Normal}
The \distname{Normal} distribution (or Gaussian) distribution is an extremely
