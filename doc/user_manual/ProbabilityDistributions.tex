...
needs to be used to initialized the distribution. In addition, the user is required to specify which type (cdf or pdf) or values
...
Refer to the test example (tests/framework/test) for more clarification.
...
\begin{itemize}
  ...
  \item \xmlNode{workingDir}, \xmlDesc{string, optional parameter}, working directory that contains the input file.
  \item \item \xmlNode{functionType}, \xmlDesc{string, required parameter}, type of initialization values specified in the input file (pdf or cdf).
  \item \xmlNode{variableID}, \xmlDesc{string, required parameter}, ID of the variable to be considered in the input file.
  \item \xmlNode{functionID}, \xmlDesc{string, required parameter}, ID of the function associated to the consider variable in the input file.
\end{itemize}
