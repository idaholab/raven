...
that can have $N$ integer values having equal probability value.
This distribution allows the user to choose two kinds of sampling strategy: with and without replacement.
...
\begin{itemize}
  ...
  (orderedWithReplacement or orderedWithoutReplacement).
  %
\end{itemize}
