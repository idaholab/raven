...
while the \textbf{Metrics} block allows the user to specify the similarity/dissimilarity metrics to be used in this
...
\begin{itemize}
  ...
  \item \xmlNode{n\_folds}, \xmlDesc{integer, optional field}, number of folds, must be at least 2. \default{3} 
