...
\begin{itemize}
  ...
  both  \xmlNode{manifest} and \xmlNode{latent} subnodes should be defined in node \xmlNode{features}. The transformation matrix
  ...
  matrix is used to map the manifest variables to the latent variables in the transformed space.
