...
\begin{itemize}
   ...
   \nb Used just in case the  \xmlNode{pivotValue}-based operation  is requested
    \item \xmlNode{operator}, \xmlDesc{string, optional field}, the operation to perform on the output space:
     ...
     \item \xmlNode{pivotValue}, \xmlDesc{float, optional field}, the value of the pivotParameter with respect the other outputs need to be extracted.
     ...
     \item \xmlNode{pivotStrategy}, \xmlDesc{string, optional field}, The strategy to use for the pivotValue:
       \begin{itemize}
        ...
        \item \textbf{floor}, find the value that is the nearest with respect the \xmlNode{pivotValue} but < of the  \xmlNode{pivotValue}
        \item \textbf{celing}, find the value that is the nearest with respect the \xmlNode{pivotValue} but > of the  \xmlNode{pivotValue}
...
This example will show how to XML input block would look like:
