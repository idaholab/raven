...
\begin{itemize}
   ...
   \item \xmlNode{variable}, \xmlDesc{string, required field}, ID of the input variable. This node is provided for each input variable. This nodes needs to contain also these attributes:
                                                               \begin{itemize}
                                                                 \item \xmlAttr{R0values}, \xmlDesc{string, required field}, interval of values that implies a reliability value equal to $0$ for the
                                                                 input variable
                                                                 \item \xmlAttr{R1values}, \xmlDesc{string, required field}, interval of values that implies a reliability value equal to $1$ for the
                                                                 input variable
                                                               \end{itemize}
