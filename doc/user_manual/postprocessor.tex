...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \xmlAttr{prefix}, \xmlDesc{required string attribute}, user-defined prefix for the given \textbf{metric}.
      For scalar quantifies, RAVEN will define a variable with name defined as:  ``prefix'' + ``\_'' + ``parameter anme''.
      ...
      This variable will be used by RAVEN for the internally calculations. It is also accessible by the user through
...
\label{MetricPP}
The \textbf{Metric} post-processor is specifically used to calculate the distance values among points from PointSet and histories from HistorySet,
