...
\begin{itemize}
  ...
  \item symbolic/numerical definition of sequences: if the ET contains a symbolic sequence then a .xml file is generated.  This file contains
        ...
        and "_mapping". As an example the file "eventTree_mapping.xml" generated by RAVEN:
        \begin{lstlisting}[style=XML]
            <map Tree="eventTree">
        ...
        \end{lstlisting}
        contains the mapping of four sequences defined in the ET (seq_1,seq_2,seq_3,seq_4) with the IDs generated by RAVEN (0,1,2,3).
