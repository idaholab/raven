...
\maljdan{Do we want the equivalent command for Ubuntu?} \alfoa{I think so. Please ask Josh.}
...
\subsubsection{Compilation}
%\maljdan{Do they need to build CROW first?} \alfoa{No.Crow is compiled and distributed in \texttt{raven\_libs\_framework\_and\_crow.dmg}}
