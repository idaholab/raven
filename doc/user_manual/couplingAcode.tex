...
If the newly-developped  Interface requires additional libraries (installable via PIP, CONDA or MAMBA), the 
...
Such  ``\textbf{dependecies.xml}''  file has the same structure of the RAVEN or RAVEN-based Plugin  ``\textbf{dependecies.xml}'' file.
