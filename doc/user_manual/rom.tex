...
For the purpose of exporting RAVEN trained ROMs in Pyomo format, the platform to print the Pyomo python file is estblished.
...
and loading of the ROM file must use \xmlNode{IOStep}.

\textbf{Example:} For this example the external model is trained and further loaded as `out_rom'. The loaded trained model is separately
processed to `rom_out.py' and `rom_pickle.pk'.
\begin{lstlisting}[style=XML,morekeywords={name,subType}]
  <Simulation>
    ...
    <Files>
