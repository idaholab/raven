...
The file names `printed\_python\_file' and `rom\_pickled_file' are arbitrary names, and are not requirements.
...
When running the command a text file named `GreyModelOutput\_cyipopt.txt' will be created showing the results of the optimization.
