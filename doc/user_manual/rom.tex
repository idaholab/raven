...
\begin{itemize}
  ...
  coefficients. Only valid in case of  \xmlNode{coeffRegressor} set to ``poly''. 
   \default{2}
 \item \xmlNode{initialScaling}, \xmlDesc{float, optional field}, scaling factor for the target space
  \default{1.0}
...
<Simulation>
  ...
  <Models>
   ...
   <ROM name='PolyExp' subType='PolyExponential'>
     ...
     <initialScaling>20.</initialScaling>
...
\begin{itemize}
  \item \xmlNode{expTerms}, see XML input specifications above
  \item \xmlNode{coeffRegressor}, see XML input specifications above
  \item \xmlNode{initialScaling}, see XML input specifications above
...
<Simulation>
  ...
  <Models>
   ...
   <ROM name='DMD' subType='DMD'>
      ...
      <pivotParameter>time</pivotParameter>
      <rankSVD>0</rankSVD>
      <initialScaling>30000000.</initialScaling>
      <rankTLSQ>5</rankTLSQ>
