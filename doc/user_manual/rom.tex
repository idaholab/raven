...
{
  \textcolor{red}{
  \\It is important to NOTICE that RAVEN does not pre-normalize the training data before 
  constructing the \textit{#1} ROM.}
}
...
\\ 
\textcolor{red}{\\\textbf{It is important to notice that RAVEN uses a Z-score normalization of the training data before constructing most of the 
