...
representation matrices A, B (and optional C) in a discrete time domain. 

\begin{itemize}
\item x[k+1]=A*x[k]+B*u[k]
\item y[k+1]=C*x[k+1] (optional)
\end{itemize}
...
\begin{itemize}
  ...
  of this model. Each actuator variabls (u1, u2, etc.) needs to be listed here.
