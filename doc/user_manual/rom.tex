  ...
  \item \xmlNode{Segment}, \xmlDesc{node, optional}, provides an alternative way to build the ROM. When
    ...
    \begin{itemize}
      ...
      \item \xmlNode{evalMode}, \xmlDesc{string, optional field}, one of \xmlString{truncated},
        ...
        \end{itemize}
     \item \xmlNode{evaluationClusterChoice}, \xmlDesc{string, optional field}, one of \xmlString{first},
        \xmlString{random}, or \xmlString{centroid}, determines, if \xmlAttr{grouping}$=cluster$, which 
        ...
        first ROM (representative segmented ROM),in each cluster, is considered to
         ...
         is choosen when an evaluation is requested; If ``centroid'', a ROM ``trained" on the centroids 
