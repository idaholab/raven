...
a gradient-based \xmlNode{Optimizer} as the sampling strategy. It is generally used to show the progressive
...
used for gradient evaluation, only points that were considered as potential optimal points during
the gradient descent search.

If the \xmlString{accepted} key value is included in the \xmlNode{SolutionExport} DataObject, this
plotter will use colors and markers to identify the main types of iterations in a gradient-based
optimizer:
\begin{itemize}
