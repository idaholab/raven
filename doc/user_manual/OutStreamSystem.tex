...
\newcommand{\interpYDescription}[1]
{
}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsubsection{2D \& 3D Line plot}
  ...
  \begin{itemize}
    ...
    \item \xmlNode{interpPointsX}, \xmlDesc{integer, optional field}, represents
    the number of points to be use for interpolation of x axis.
    \item \xmlNode{interpPointsY}, \xmlDesc{integer, optional field}, represents
    the number of points to use for interpolation of y axis (only 3D line plot).
  \end{itemize}
...
\subsubsection{2D Pseudocolor plot}
  ...
  \begin{itemize}
    \item \interpolationDescription[linear]
    \item \xmlNode{interpPointsX}, \xmlDesc{integer, optional field}, specifies
    the number of points need to be used for interpolation of x axis.
    \item \xmlNode{kwargs}, within this block the user can specify optional
    parameters with the following format:
...
\begin{itemize}
  ...
  \default{5}
  \item \interpolationDescription{linear}
  \item \xmlNode{interpPointsX}, \xmlDesc{integer, optional field}, is the
...
\begin{itemize}
  ...
  %
  \default{1}
  \item \xmlNode{cmap}, \xmlDesc{string, optional field}, defines the color map
  to use.
  %
  \default{jet}
  ...
  \default{0}
  \item \interpolationDescription{linear}
  \item \xmlNode{interpPointsX}, \xmlDesc{integer, optional field}, sets the
  number of points to use for interpolation of the x axis.
  \item \xmlNode{interpPointsY}, \xmlDesc{integer, optional field}, sets the 
  number of points to use for interpolation of the y axis.
  \item \xmlNode{kwargs}, within this block the user can specify optional
  parameters with the following format:
...
\begin{itemize}
  ...
  \item \interpolationDescription{linear}
  \item \xmlNode{interpPointsX}, \xmlDesc{integer, optional field}, sets the 
  number of points need to be used for interpolation of the x axis.
  \item \xmlNode{interpPointsY}, \xmlDesc{integer, optional field}, sets the 
  number of points need to be used for interpolation of the y axis.
  \item \xmlNode{kwargs}, within this block the user can specify optional
  parameters with the following format:
