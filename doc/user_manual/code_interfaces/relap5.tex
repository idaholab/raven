   ...
   \item \xmlNode{datatypes}, \xmlDesc{XML node, optional parameter}, The datatypes block.
    This XML node can optionally contain the following attribute:
     \begin{itemize}
      ...
      \item \textit{floats}, \xmlDesc{comma separated list, optional parameter}, The list of cards that must
      be cast as floats (e.g. 1180802:2,1180803:2)
      \end{itemize}
\end{itemize}
...
<Models>
  <Code name='MyRELAP' subType='Relap5'>
    ...
    <datatypes>
      ...
      <floats>1180801:2,1180802:2,1180901:3</floats>
    </datatypes>
    ...
  </Code>
</Models>
