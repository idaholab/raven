...
\subsubsection{NDspline}
  ...
  \default{None}
            ...
            \item \xmlNode{onlyOutputScore}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
              If maxNumberFeatures is on, only output score should be considered?.
  \default{False}

            \item \xmlNode{searchTol}: \xmlDesc{float}, 
              Relative tolerance for serarch! Only if maxNumberFeatures is set
  \default{0.0001}

            \item \xmlNode{applyClusteringFiltering}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
              Applying clustering before RFE search?
  \default{False}

            \item \xmlNode{applyCrossCorrelation}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
              Applying cross correlation in case of subgroupping at the end of the RFE
  \default{False}
  ...
  \default{1}
            ...
            \item \xmlNode{subGroup}: \xmlDesc{comma-separated strings, integers, and floats}, 
              Subgroup of output variables on which to perform the search
          \end{itemize}
