...
\subsubsection{NDspline}
  ...
  \default{time}
    ...
    \item \xmlNode{featureSelection}:
      ...
      \begin{itemize}
        \item \xmlNode{RFE}:
          The \xmlString{Augmented-RFE} (Recursive Feature Elimination) is a feature selection
          ...
          method.         \\In RAVEN the \xmlString{Augmented-RFE} class refers to an augmentation
  ...
  \default{False}
            ...
            \item \xmlNode{searchTol}: \xmlDesc{float}, 
  ...
  \default{0.0001}
            ...
            \item \xmlNode{applyClusteringFiltering}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
              Applying clustering correlation  before Augmented-RFE search?
  \default{False}

            \item \xmlNode{applyCrossCorrelation}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
              Applying cross correlation in case of subgroupping at the end of the Augmented-RFE
  \default{False}
  ...
  \default{1}
            ...
            \item \xmlNode{subGroup}: \xmlDesc{comma-separated strings, integers, and floats}, 
              ...
              type can be inputted. The Augmented-RFE search will be then performed on each
              ``subgroup'' separately and then the the union of the different feature sets are used
              for the final ROM.
          \end{itemize}

        \item \xmlNode{VarianceThreshold}:
          The \xmlString{VarianceThreshold} is a feature selector that removes all low-variance
          features.                            This feature selection algorithm looks only at the
          features and not the desired outputs. The                            variance threshold
  ...
  \default{0.0}
    ...
    \item \xmlNode{dimensionalityReduction}:
      Use dimensionality reduction for the feature space?

      The \xmlNode{dimensionalityReduction} node recognizes the following subnodes:
      \begin{itemize}
        \item \xmlNode{PCA}:
          Use PCA

          The \xmlNode{PCA} node recognizes the following subnodes:
          \begin{itemize}
            \item \xmlNode{parametersToInclude}: \xmlDesc{comma-separated strings}, 
  ...
  \default{Feature}
            ...
            \item \xmlNode{whiten}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
              Whiten the signal?
  \default{False}

            \item \xmlNode{tol}: \xmlDesc{[True, Yes, 1, False, No, 0, t, y, 1, f, n, 0]}, 
