...
\subsubsection{DMD}
  ...
  \default{RBF}
    ...
    \item \xmlNode{approximationSettings}: \xmlDesc{[RBF, GPR]}, 
  ...
  \default{None}
        ...
        \item \xmlNode{optimization\_restart}: \xmlDesc{integer},
          ...
          all bounds must be finite. Note that $optimization\_restart == 0$ implies that one run is
          performed.
  \default{0}
...
\subsubsection{HODMD}
  ...
  \default{False}
    ...
    \item \xmlNode{rescale\_mode}: \xmlDesc{[auto, None]}, 
      Scale Atilde as shown in \url{10.1016/j.jneumeth.2015.10.010} (section 2.4) before computing its
