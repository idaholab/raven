...
\begin{itemize}
  \item \xmlNode{actionType}, \xmlDesc{string, required field}, the type time scaling selected for post-processor PPDSS (see \ref{subsubsec:Validation}). The options are: `DataSynthesis', `2\_2\_affine', `dilation', `beta\_strain', `omega\_strain', and `identity'.
\end{itemize}
