...
but is computationally expensive when no connectivity constraints are added between samples: it considers at each step all the possible merges.
...
\begin{itemize}
  ...
  \item \xmlNode{compute\_full\_tree}, \xmlDesc{bool or 'auto', optional field}, top early the construction of the tree at \xmlNode{n\_clusters}.
