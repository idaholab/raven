...
The temporal variable for \xmlString{temporalSciKitLearn} is specified in the \xmlNode{pivotParameter} node:
\begin{itemize}
  \item \xmlNode{pivotParameter}, \xmlDesc{string, optional parameter} specifies the pivot variable (e.g., time, etc) in the input HistorySet. This option is for \xmlString{temporalSciKitLearn} library only.
      \default{`Time'}.
\end{itemize}
