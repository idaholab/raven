...
The temporal variable for \xmlString{temporalSciKitLearn} is specified in the \xmlNode{timeID} node: 
\begin{itemize}
  \item \xmlNode{timeID}, \xmlDesc{string, optional parameter} specifies the temporal variable in the input HistorySet. This option is for \xmlString{temporalSciKitLearn} library only.
      \default{`Time'}. 
\end{itemize}
