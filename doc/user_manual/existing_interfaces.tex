...
\subsubsection{Files}
In the \xmlNode{Files} section, as specified before, there should be specified all the
...
In the \xmlNode{Sequence} section there should be specified the names of the steps
declared in the \xmlNode{Steps} block.
%
...
For the \xmlNode{batchSize} and \xmlNode{mode} sections please take a look at the RunInfo
...
For the \xmlNode{Models} block here is a standard example of what can be used to use
...
In the \xmlNode{Distribution} block are defined the distributions that are going to be
used for the sampling of the variables defined in the \xmlNode{Samplers} block.
%
...
In the \xmlNode{Samplers} block we want to define the variables that are going to be
sampled.
%
\textbf{Example}:
...
As shown in the \xmlNode{Steps} block, the code is creating two DataBases called
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Distributions}
The \xmlNode{Distributions} block, when using RELAP7 has to be specified also through
the control logic.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Samplers}
In the \xmlNode{Samplers} block there are going to be defined both which kind of
