...
\begin{itemize}
  ...
  $301 \:\:\: p \:\:\: 345010000$ will be named in the converted CSVs as $p\_345010000$). In addition, if a variable contains trailing spaces, the spaces are 
   going to be removed and replaces with underscores (e.g. $HTTEMP 1131008 12$ will become $HTTEMP\_1131008\_12$}.
\end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
