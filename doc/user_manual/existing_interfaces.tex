...
The location of the value outputted is defined as \textit{R\#ID\#} and the value is as 
\textit{R\#value\#}. The first ''\#'' is the number of the ring, and the second one defines
the number of the location. The example below contains 2 rings in the [DomainIntegral] 
section with 3 locations where the values are outputted.
...
\begin{lstlisting}[style=XML]
  <DataObjects>
    <PointSet name="collset">
      ...
      <Output>R1ID1,R1ID2,R1ID3,R1value1,R1value2,R1value3,
              R2ID1,R2ID2,R2value1,R2value2</Output>
    </PointSet>
  </DataObjects>
\end{lstlisting}
