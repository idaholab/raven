...
Some use software requires a provided mesh that requires a separate code run to generate.  
...
geometry and meshing for calculations.  The input parameters for Cubit can be listed in a journal
