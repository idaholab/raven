...
the GenericCode interface can be invoked using the \xmlNode{fileargs}
node of type \xmlAttr{output} specifying the output file name in the
  \xmlAttr{args}  attribute.
...
\begin{lstlisting}[style=XML]
    <Code name="poly" subType="GenericCode">
      ...
      <clargs   type='input'   arg='-i'  extension='.one'/>
      <fileargs type='input'   arg='two' extension='.two'/>
      <fileargs  type="output" arg="fixed_output.csv"/>
      <prepend>python</prepend>
    </Code>
\end{lstlisting}
