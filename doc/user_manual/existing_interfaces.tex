...
The user must edit the \texttt{aux-input-files} so that it
...
\item while in \texttt{framework/CodeInterfaces/SERPENT}, run \texttt{python generateCustomVariable.py}
\end{enumerate}

This will automatically generate the feature and target space with isotopes.
