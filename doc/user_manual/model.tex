...
\begin{itemize}
  ...
  \begin{itemize}
     ...
     \item \xmlNode{tolerance}, \xmlDesc{float, optional field}, ROMs convergence criterion. This tolerance will
       ...
       \nb Currently, this tolerance can be only used for cross validations with SKL Metrics: \textit{euclidean},
       \textit{cityblock}, \textit{l1}, \textit{l2} and \textit{manhattan}.
        \default{0.01};
