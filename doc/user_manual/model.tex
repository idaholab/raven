...
The other method is used by specifying \xmlNode{syncMethod} as \xmlString{all}.  This will iterate through the
...
\begin{itemize}
   ...
   \item \xmlNode{syncMethod}, \xmlDesc{string, required field}, synchronization strategy to employ
