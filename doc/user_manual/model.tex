...
to create new Post-Processor. While the External Post-Processor (see
...
\begin{itemize}
  ...
  post-processors. Mandatory elements that needs to be specified are the
  following:
\begin{itemize}
...
\end{itemize}
  ...
  \item run: this method performs the desired computation of the data object.
\end{itemize}
...
The user is not allowed to modify directly the DataObjects, however their
content is available in the form of a python dictionary. Similarly, the output
of the PostProcessor is a python dictionary.
