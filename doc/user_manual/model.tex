...
\begin{itemize}
  ...
  Any amount of whitespace is acceptable.  See the example below. \nb{Using custom index sets
  may not result in a stable solution.}
  %
...
<Simulation>
  ...
  <Models>
    ...
    <ROM name='myRom' subType='GaussPolynomialRom'>
      ...
      <IndexPoints>(0,1),(0,2),(1,1),(4,0)<IndexPoints>
...
\paragraph{LimitSurfaceIntegral}
