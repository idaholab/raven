...
\vspace{-5mm}
  ...
  \begin{itemize}
     ...
     \item \xmlNode{Output}, \xmlDesc{string, optional field},
        represents the output entities that need to be linked to this sub-model. This XML block(s) can
        be omitted since it (they) is (are) optional.  \nb The \xmlNode{Output}s here specified are not part 
        ...
        %
        The user can specify as many \xmlNode{Output} as needed.
    \end{itemize}
  %
\end{itemize}
