...
In order to use the  \textit{Automatic Relevance Determination} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|ARDRegression</SKLtype>$. In addition to this XML node, several other need (or not) be inputted:
\begin{itemize}
...
In order to use the  \textit{Bayesian ridge regression} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|BayesianRidge</SKLtype>$.  In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
\item $<n_iter>$ \textbf{\textit{, integer, optional field.}}.  Maximum number of iterations. \textit{Default = 300};
\item $<tol>$ \textbf{\textit{, float, optional field.}}.  Stop the algorithm if w has converged. \textit{Default = 1.e-3};
\item $<alpha_1>$ \textbf{\textit{, float, optional field.}}.  Hyper-parameter : shape parameter for the Gamma distribution prior over the alpha parameter. \textit{Default =  1.e-6};
...
\end{equation}
In order to use the  \textit{Elastic Net} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|ElasticNet</SKLtype>$.  In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the  \textit{Elastic Net CV} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|ElasticNetCV</SKLtype>$. In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the  \textit{Least Angle Regression model} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|Lars</SKLtype>$. In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the  \textit{Cross-validated Least Angle Regression model} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LarsCV</SKLtype>$. In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
\item $<fit_intercept>$ \textbf{\textit{, boolean, optional field.}}.  Whether the intercept should be estimated or not. If False, the data is assumed to be already centered. \textit{Default =  True};
\item $<verbose>$ \textbf{\textit{, boolean, optional field.}}.  Verbose mode when fitting the model. \textit{Default =  False};
\item $<normalize>$ \textbf{\textit{, boolean, optional field.}}.  If True, the regressors X will be normalized before regression. \textit{Default =  False};
...
\\In order to use the \textit{Linear Model trained with L1 prior as regularizer (Lasso)} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|Lasso</SKLtype>$.
...
\\In order to use the \textit{Lasso linear model with iterative fitting along a regularization path} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LassoCV</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Cross-validated Least Angle Regression model} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LarsCV</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<fit \textunderscore intercept>$ \textbf{\textit{, boolean.}}. whether to calculate the intercept for this model. If set to false, no intercept will be used in calculations (e.g. data is expected to be already centered).
...
\\In order to use the \textit{Cross-validated Lasso, using the LARS algorithm} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LassoLarsCV</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<fit \textunderscore intercept>$ \textbf{\textit{, boolean.}}. whether to calculate the intercept for this model. If set to false, no intercept will be used in calculations (e.g. data is expected to be already centered).
  \item $<verbose>$ \textbf{\textit{, boolean or integer, optional field.}}. Sets the verbosity amount
...
\\In order to use the \textit{Lasso model fit with Lars using BIC or AIC for model selection} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LassoLarsIC</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Ordinary least squares Linear Regression} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LinearRegression</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Logistic Regression} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|LogisticRegression</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Multi-task Lasso model trained with L1/L2 mixed-norm as regularizer} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|MultiTaskLasso</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Multi-task ElasticNet model trained with L1/L2 mixed-norm as regularizer} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|MultiTaskElasticNet</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<alpha>$ \textbf{\textit{, float, optional field.}}. Constant that multiplies the L1/L2 term. Defaults to 1.0
...
\\In order to use the \textit{Orthogonal Mathching Pursuit model (OMP)} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|OrthogonalMatchingPursuit</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Cross-validated Orthogonal Mathching Pursuit model (OMP)} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|OrthogonalMatchingPursuitCV</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<fit \textunderscore intercept>$ \textbf{\textit{, boolean, optional field.}}. whether to calculate the intercept for this model. If set to false, no intercept will be used in calculations (e.g. data is expected to be already centered).
  \item $<normalize>$ \textbf{\textit{, boolean, optional field.}}. If False, the regressors X are assumed to be already normalized.
...
\\In order to use the \textit{Passive Aggressive Classifier} classifier, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|PassiveAggressiveClassifier</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Passive Aggressive Regressor} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|PassiveAggressiveRegressor</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<C>$ \textbf{\textit{, float.}}. Maximum step size (regularization). Defaults to 1.0.
...
\\In order to use the \textit{Perceptron} classifier, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|Perceptron</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Randomized Lasso} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|RandomizedLasso</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Randomized Logistic Regression} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|RandomizedLogisticRegression</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Linear least squares with l2 regularization} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|Ridge</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Classifier using Ridge regression} classifier, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|RidgeClassifier</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Ridge classifier with built-in cross-validation} classifier, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|RidgeClassifierCV</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Ridge regression with built-in cross-validation} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|RidgeCV</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<alphas>$ \textbf{\textit{, numpy array of shape [n\textunderscore alphas] .}}. Array of alpha values to try. Small positive values of alpha improve the conditioning of the problem and reduce the variance of the estimates. Alpha corresponds to $(2*C)^-1$ in other linear models such as LogisticRegression or LinearSVC.
  \item $<fit\textunderscore intercept>$ \textbf{\textit{, boolean.}}. Whether to calculate the intercept for this model. If set to false, no intercept will be used in calculations (e.g. data is expected to be already centered).
...
\\In order to use the \textit{Linear classifiers (SVM, logistic regression, a.o.) with SGD training} WHAT, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|SGDClassifier</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
$<SKLtype>linear\textunderscore model|FW\textunderscore NAME</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Compute Least Angle Regression or Lasso path using LARS algorithm} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|lars\textunderscore path</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
$||W||_21 = \sum_i \sqrt{\sum_j w_{ij}^2}$
i.e. the sum of norm of each row.
\\In order to use the \textit{Compute Lasso path with coordinate descent} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|lasso\textunderscore path</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\mbox{}
\\In order to use the \textit{Stability path based on randomized Lasso estimates} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|lasso\textunderscore stability\textunderscore path</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{NAME} regressor, the user needs to set the sub-node $<SKLtype>linear\textunderscore model|orthogonal\textunderscore mp\textunderscore gram</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  ...
  \item $<norms\textunderscore squared>$ \textbf{\textit{, array-like, shape (n\textunderscore targets).}}. 
\end{itemize}
...
\\In order to use the \textit{Linear Support Vector Classifier} classifier, the user needs to set the sub-node $<SKLtype>svm|LinearSVC</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{C-Support Vector Classification} classifier, the user needs to set the sub-node $<SKLtype>svm|SVC</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Nu-Support Vector Classification} classifier, the user needs to set the sub-node $<SKLtype>svm|NuSVC</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
...
\\In order to use the \textit{Support Vector Regression} regressor, the user needs to set the sub-node $<SKLtype>svm|SVR</SKLtype>$.
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item $<C>$ \textbf{\textit{, float, optional field (default=1.0).}}. penalty parameter C of the error term.
