...
The \textbf{LimitSurfaceIntegral} post-processor is aimed to compute the probability of the event that
generated a Limit Surface (either from the LimitSurface post-processor or Adaptive sampling strategies).
The inputted Limit Surface needs to be, in the  \textbf{PostProcess} step, of type  \textbf{TimePointSet}.
...
\end{itemize}
\end{itemize}
%The  \textbf{LimitSurfaceIntegral} 
%
%
