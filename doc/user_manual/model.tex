...
Currently in RAVEN, the ROMs are classified into 5 sub-types that, once chosen,
...
\begin{itemize}
  ...
  the 5 sub-types should be used, choosing among the previously reported
  types.
  %
...
\item \xmlNode{kind}: specifies information to use for comparing the
  ...
  \begin{itemize}
  \item \xmlAttr{num\_bins} which takes a number that directly
    specifies the number of bins
  \item \xmlAttr{bin\_method} which takes a string that specifies the
