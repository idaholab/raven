...
\renewcommand{\specBlock}[2]{The specifications of this model must be
  defined within #1 \xmlNode{#2} XML block.}
%
\renewcommand{\subnodeIntro}{This model can be initialized with the following
  child:}
\renewcommand{\subnodesIntro}{This model can be initialized with the following
  children:}
...
{
  \xmlNode{tol}, \xmlDesc{float, optional field}, stop the algorithm if $w$ has
  converged within the tolerance specified here. \maljdan{what is w?}
  %
  \default{#1}
}
...
\begin{itemize}
  ...
  %
  \default{0.5}
  \item \xmlNode{eps} , \xmlDesc{float, optional field},
  %
  Length of the path.
  %
  ...
  %
  \default{0.001}
  \item \xmlNode{n\_alphas} , \xmlDesc{integer, optional field},
  %
  Number of alphas along the regularization path, used for each $l1_ratio$.
  %
  \default{100}
  \item \xmlNode{precompute} , \xmlDesc{boolean or string, optional field},
  %
...
\begin{itemize}
  ...
  \item \xmlNode{fit\_path} , \xmlDesc{boolean, optional field},
  %
...
\begin{itemize}
  ...
  \default{1.0}
  \item \maxIterDescription{300}
  \item \xmlNode{max\_n\_alphas}, \xmlDesc{integer, optional field},
  %
...
\begin{itemize}
  ...
  %
  \item \normalizeDescription{False}
  \item \xmlNode{precompute} , \xmlDesc{True | False | ‘auto’ |
      array-like},
  %
  Whether to use a precomputed Gram matrix to speed up calculations.
  %
...
\skltype{Lasso linear model with iterative fitting along a
  regularization path regressor}{linear\_model|LassoCV}
\begin{itemize}
  \item \xmlNode{eps} , \xmlDesc{float, optional field},
  %
  Length of the path.
  ...
  1e-3.
  %
  \item \xmlNode{n\_alphas} , \xmlDesc{int, optional field},
  %
  Number of alphas along the regularization path
  \item \xmlNode{alphas} , \xmlDesc{numpy array, optional field},
  %
...
\skltype{Cross-validated Least Angle Regression model regressor}{linear\_model|LarsCV}
\begin{itemize}
  \item \fitInterceptDescription{True}
  %
  \item \verDescriptionB
...
\skltype{Cross-validated Lasso, using the LARS algorithm regressor}{linear\_model|LassoLarsCV}
\begin{itemize}
  \item \fitInterceptDescription{True}
  %
  \item \verDescriptionB
...
\skltype{Ordinary least squares Linear Regressor}{linear\_model|LinearRegression}
\begin{itemize}
  \item \fitInterceptDescription{True}
  %
  \item \normalizeDescription{False}
...
\begin{itemize}
  \item \xmlNode{penalty} , \xmlDesc{string, ‘l1’ or ‘l2’},
  %
  Used to specify the norm used in the penalization.
  %
  \item \xmlNode{dual} , \xmlDesc{boolean},
  %
  ...
  %
  \item \xmlNode{C} , \xmlDesc{float, optional field (default: 1.0)},
  %
  ...
  regularization.
  %
  \item \xmlNode{fit\_intercept} , \xmlDesc{boolean (default:
      True)},
  %
  ...
  %
  \item \xmlNode{intercept\_scaling} , \xmlDesc{float, optional
      field (default: 1.0)},
  %
  ...
  increased
  \item \xmlNode{class\_weight} , \xmlDesc{{dict, ‘auto’},
      optional},
  %
  ...
  %
  \item \xmlNode{random\_state} , \xmlDesc{int seed, RandomState
      instance, or None (default)},
  %
...
\begin{itemize}
  ...
  \item \fitInterceptDescription{True}
  %
  \item \xmlNode{normlaize} , \xmlDesc{boolean, optional field (default:
      False)},
  %
...
%
\skltype{Orthogonal Mathching Pursuit model (OMP) regressor}{linear\_model|OrthogonalMatchingPursuit}
\begin{itemize}
  \item \xmlNode{n\_nonzero\_coefs} , \xmlDesc{
      int, optional field},
  %
  ...
  %
  \item \xmlNode{tol} , \xmlDesc{float, optional field},
  %
  ...
  %
  \item \normalizeDescription{False}
  \item \xmlNode{precompute} , \xmlDesc{{True, False, ‘auto’}, default
      ‘auto’},
  %
...
%
\skltype{Cross-validated Orthogonal Mathching Pursuit model
  (OMP) regressor}{linear\_model|OrthogonalMatchingPursuitCV}
\begin{itemize}
  \item \fitInterceptDescription{True}
  %
  \item \normalizeDescription{False}
...
%
\skltype{Passive Aggressive Classifier}{linear\_model|PassiveAggressiveClassifier}
\begin{itemize}
  ...
  \item \nIterDescriptionB{5}
  %
  \item \xmlNode{shuffle} , \xmlDesc{boolean, optional field},
  %
  ...
  %
  \item \verDescriptionB
  \item \xmlNode{loss} , \xmlDesc{string, optional field},
  %
...
\begin{itemize}
  \item \xmlNode{penalty} , \xmlDesc{None, ‘l2’ or ‘l1’ or
      ‘elasticnet’},
  %
  ...
  %
  \item \verDescriptionB
  \item \xmlNode{eta0} , \xmlDesc{double, optional field},
  %
  Constant by which the updates are multiplied.
  %
  Defaults to 1.
  %
  \item \xmlNode{class\_weight} , \xmlDesc{dict, {class
       \_label}},
  %
...
\begin{itemize}
  \item \xmlNode{alpha} , \xmlDesc{float, ‘aic’, or ‘bic’, optional},
  %
  ...
  which is scaling.
  %
  \item \xmlNode{scaling} , \xmlDesc{float, optional field},
  %
  ...
  %
  \item \xmlNode{sample\_fraction} , \xmlDesc{float, optional
      field},
  %
  ...
  %
  \item \xmlNode{n\_resampling} , \xmlDesc{int, optional
      field},
  %
  Number of randomized models.
  %
  \item \xmlNode{selection\_threshold} , \xmlDesc{float, optional
      field},
  %
  ...
  %
  \item \xmlNode{random\_state} , \xmlDesc{int, RandomState
...
It is also known as stability selection.
%
\skltype{Randomized Logistic Regressor}{linear\_model|RandomizedLogisticRegression}
\begin{itemize}
  \item \xmlNode{C} , \xmlDesc{float, optional field (default=1)},
  %
  The regularization parameter C in the LogisticRegression.
  %
  \item \xmlNode{scaling} , \xmlDesc{float, optional field (default=0.5)},
  %
  The alpha parameter in the stability selection article used to randomly scale
  the features.
  %
  ...
  If 1, all samples are used.
  %
  \item \xmlNode{n\_resampling} , \xmlDesc{int, optional field
      (default=200)},
  %
  Number of randomized models.
  %
...
\begin{itemize}
  ...
  \item \normalizeDescription{True}
  %
  \item \xmlNode{solver} , \xmlDesc{{‘auto’, ‘svd’, ‘cholesky’,
        ‘lsqr’, ‘sparse\_cg’}},
  %
...
\begin{itemize}
  ...
  LogisticRegression or LinearSVC.
  %
  \item \xmlNode{class\_weight} , \xmlDesc{dic, optional
      field},
  %
...
handled efficiently.
%
\skltype{Ridge classifier with built-in cross-validation classifier}{linear\_model|RidgeClassifierCV}
\begin{itemize}
  \item \xmlNode{alphas} , \xmlDesc{numpy array of shape [n\_alphas]},
  %
  ...
  \item \normalizeDescription{False}
  %
  \item \xmlNode{scoring} , \xmlDesc{string, callable or None, optional,
      default: None},
  %
...
\begin{itemize}
  ...
  function with signature scorer(estimator, X, y).
  %
  \item \xmlNode{cv} , \xmlDesc{cross-validation generator, optional field},
  %
  If None, Generalized Cross-Validation (efficient Leave-One-Out) will be used.
  %
  \item \xmlNode{gcv\_mode} , \xmlDesc{{None, ‘auto’,
        ‘svd’, eigen’}, optional field},
  %
  ...
  %
  \item \xmlNode{store\_cv\_values} , \xmlDesc{
...
%
\skltype{Linear classifiers (SVM, logistic regression, a.o.) with SGD training}{linear\_model|SGDClassifier}
\begin{itemize}
  \item \xmlNode{loss} , \xmlDesc{str, ‘hinge’, ‘log’,
      ‘modified\_huber’, ‘squared\_hinge’,
      ‘perceptron’, or a regression loss: ‘squared\_loss’,
  ...
  %
  \item \xmlNode{penalty} , \xmlDesc{str, ‘l2’ or ‘l1’ or
      ‘elasticnet’},
  %
  The penalty (aka regularization term) to be used.
  %
  ...
  %
  \item \verDescriptionB
  \item \xmlNode{epsilon} , \xmlDesc{int, optional field},
  %
  ...
  ‘optimal’.
  %
  \item \xmlNode{power\_t} , \xmlDesc{double},
  %
  The exponent for inverse scaling learning rate [default 0.5].
  %
  \item \xmlNode{class\_weight} , \xmlDesc{dict,
      {class\_label}},
  %
  Preset for the class\_weight fit parameter.
  %
...
\begin{itemize}
  \item \xmlNode{loss} , \xmlDesc{str, ‘squared\_loss’,
      ‘huber’, ‘epsilon\_insensitive’, or
      ‘squared\_epsilon\_insensitive’},
  %
  The loss function to be used.
  ...
  %
  \item \xmlNode{learning\_rate} , \xmlDesc{string, optional
      field},Learning rate: constant: eta = eta0 optimal: eta = 1.0/(t+t0)
  invscaling: eta= eta0 / pow(t, power\_t) [default]
  \item \xmlNode{eta0} , \xmlDesc{double},
  %
  The initial learning rate [default 0.01].
  %
  \item \xmlNode{power\_t} , \xmlDesc{double, optional field},
  %
...
\skltype{Compute Least Angle Regression or Lasso path using
  LARS algorithm regressor}{linear\_model|lars\_path}
\begin{itemize}
  \item \xmlNode{X} , \xmlDesc{array, shape: (n\_samples,
      n\_features)},
  %
  Input data.
  %
  \item \xmlNode{y} , \xmlDesc{array, shape: (n\_samples)},
  %
  Input targets.
  %
  ...
  %
  \item \xmlNode{alpha\_min} , \xmlDesc{float, optional field
      (default=0)},
  %
  ...
  %
  \item \xmlNode{method} , \xmlDesc{{‘lar’, ‘lasso’}, optional
      (default=’lar’)},
  %
  ...
  %
  \item \xmlNode{eps} , \xmlDesc{float, optional
...
\begin{itemize}
  \item \xmlNode{X} , \xmlDesc{{array-like, sparse matrix}, shape
  ...
  %
  \item \xmlNode{y} , \xmlDesc{ndarray, shape = (n\_samples,), or
  ...
  %
  Number of alphas along the regularization path
  \item \xmlNode{alphas} , \xmlDesc{ndarray, optional field},
  %
  List of alphas where to compute the models.
  %
  If None alphas are set automatically
  ...
  %
  \item \xmlNode{copy\_X} , \xmlDesc{boolean, optional field
      (default True)},
  %
  If True, X will be copied; else, it may be overwritten.
  %
  \item \xmlNode{coef\_init} , \xmlDesc{array, shape
      (n\_features, ) | None},
  %
...
\begin{itemize}
  ...
  training data.
  %
  \item \xmlNode{y} , \xmlDesc{array-like, shape = [n\_samples]},
  %
  target values.
  %
  \item \xmlNode{scaling} , \xmlDesc{float, optional, default=0.5},
  %
  The alpha parameter in the stability selection article used to randomly scale
  the features.
  %
  ...
  Number of randomized models.
  %
  \item \xmlNode{n\_grid} , \xmlDesc{int, optional,
      default=100},
  %
...
\begin{itemize}
  \item \xmlNode{Gram} , \xmlDesc{array, shape (n\_features,
      n\_features)},
  %
  Gram matrix of the input data: X.T * X
  \item \xmlNode{Xy} , \xmlDesc{array, shape (n\_features,) or
      (n\_features, n\_targets) },
  %
  Input targets multiplied by X: X.T * y
  \item \xmlNode{n\_nonzero\_coefs}, \xmlDesc{int},
  %
  Desired number of non-zero entries in the solution.
  %
  If None (by default) this value is set to 10\% of n\_features.
  ...
  If not None, overrides n\_nonzero\_coefs.
  %
  \item \xmlNode{norms\_squared} , \xmlDesc{array-like, shape
      (n\_targets)},
  %
\end{itemize}
...
\begin{itemize}
  \item \xmlNode{C} , \xmlDesc{boolean, optional field (default=1.0)},
  %
  Penalty parameter C of the error term.
  %
  \item \xmlNode{loss} , \xmlDesc{string, ‘l1’ or ‘l2’
      (default=’l2’)},
  %
  ...
  %
  \item \xmlNode{dual} , \xmlDesc{boolean (default=True)},
  %
  ...
  \item \tolDescriptionC{}
  %
  \item \xmlNode{multi\_class} , \xmlDesc{string, ‘ovr’ or
      ‘crammer\_singer’ (default=’ovr’)},
  %
...
\begin{itemize}
  ...
  Penalty parameter C of the error term.
  %
  \item \xmlNode{kernel} , \xmlDesc{string, optional (default=’rbf’)},
  %
  ...
  %
  \item \xmlNode{degree} , \xmlDesc{int, optional field (default=3)},
  %
  Degree of the polynomial kernel function (‘poly’).
  %
  Ignored by all other kernels.
  %
  \item \xmlNode{gamma} , \xmlDesc{float, optional field (default=0.0)},
  %
  Kernel coefficient for ‘rbf’, ‘poly’ and ‘sigmoid’.
  %
  If gamma is 0.0 then 1/n\_features will be used instead.
  %
  \item \xmlNode{coef0} , \xmlDesc{float, optional field (default=0.0)},
  %
  Independent term in kernel function.
  %
  It is only significant in ‘poly’ and ‘sigmoid’.
  %
  \item \xmlNode{probability} , \xmlDesc{boolean, optional field
      (default=False)},
  %
  ...
  %
  \item \xmlNode{shrinking} , \xmlDesc{boolean, optional field
      (default=True)},
  %
  ...
  \item \tolDescriptionC{}
  %
  \item \xmlNode{cache\_size} , \xmlDesc{float, optional
      field},
  %
...
\begin{itemize}
  \item \xmlNode{nu} , \xmlDesc{float, optional field (default=0.5)},
  %
  ...
  %
  \item \xmlNode{kernel} , \xmlDesc{string, optional field
      (default=’rbf’)},
  %
  Specifies the kernel type to be used in the algorithm.
  %
  ...
  independent term in kernel function.
  %
  It is only significant in poly/sigmoid.
  %
  \item \xmlNode{probability} , \xmlDesc{boolean, optional field
      (default=False)},
  %
...
\begin{itemize}
  ...
  penalty parameter C of the error term.
  %
  \item \xmlNode{epsilon} , \xmlDesc{float, optional field (default=0.1)},
  %
  epsilon in the epsilon-SVR model.
  %
  It specifies the epsilon-tube within which no penalty is associated in the
  training loss function with points predicted within a distance epsilon from
  the actual value.
  %
  \item \xmlNode{kernel} , \xmlDesc{string, optional field
      (default=’rbf’)},
  ...
  If a callable is given it is used to precompute the kernel matrix.
  %
  \item \xmlNode{degree} , \xmlDesc{float, optional field (default=3.0)},
  %
  degree of kernel function is significant only in poly, rbf, sigmoid
  \item \xmlNode{gamma} , \xmlDesc{float, optional field (default=0.0)},
  %
  ...
  Specify the size of the kernel cache (in MB)
  \item \verDescriptionA
  Note that this setting takes advantage of a per-process runtime setting in
  libsvm that, if enabled, may not work properly in a multithreaded context.
  %
  \item \maxIterDescription{-1}
  %
...
\begin{itemize}
  \item \xmlNode{estimator} , \xmlDesc{boolean, required field},
  %
...
\begin{itemize}
  \item \xmlNode{estimator} , \xmlDesc{xml node, required field},
  %
  An estimator object implementing fit and one of decision\_function or
  predict\_proba.
  %
...
\begin{itemize}
    ...
    on the chosen ROM;
\end{itemize}
  \item \xmlNode{code\_size} , \xmlDesc{float, required field},
  %
...
%
\skltype{Gaussian Naive Bayes strategy}{naiveBayes|GaussianNB}
%
%%%%%%%%%%%%
...
\begin{itemize}
  ...
  %
  \default{1.0}
  \item \xmlNode{fit\_prior} , \xmlDesc{boolean, required
      field},
  %
  ...
  %
  \default{False}
  \item \xmlNode{class\_prior} , \xmlDesc{array-like float
      (n\_classes), optional field},
  %
...
\begin{itemize}
  ...
  %
  \default{None}
  \item \xmlNode{fit\_prior} , \xmlDesc{boolean, optional field},
  %
  Whether to learn class prior probabilities or not.
  %
  If false, a uniform prior will be used.
  %
  \default{False}
  \item \xmlNode{class\_prior} , \xmlDesc{array-like float (n\_classes),
      optional field},
  %
  Prior probabilities of the classes.
  %
...
\begin{itemize}
  \item \xmlNode{n\_neighbors} , \xmlDesc{integer, optional field},
  %
  Number of neighbors to use by default for k\_neighbors queries..
  %
  \default{5}
  \item \xmlNode{radius} , \xmlDesc{float, optional field},
  %
  Range of parameter space to use by default for :meth`radius\_neighbors`
  queries.
  %
  \default{1.0}
  \item \xmlNode{algorithm} , \xmlDesc{string, optional field},
  %
...
\end{itemize}
  ...
  %
  \default{auto}
  \item \xmlNode{leaf\_size} , \xmlDesc{integer, optional
      field},
  %
  ...
  %
  \default{30}
  \item \xmlNode{p} , \xmlDesc{integer, optional field},
  %
...
\begin{itemize}
  \item \xmlNode{n\_neighbors} , \xmlDesc{integer, optional
      field},
  %
  Number of neighbors to use by default for k\_neighbors queries..
  %
  \default{5}
  \item \xmlNode{weights} , \xmlDesc{string, optional field},
  %
...
\end{itemize}
  ...
  %
  \default{auto}
  \item \xmlNode{metric} , \xmlDesc{string, optional field},
  %
...
\end{itemize}
  ...
  %
  \default{2}
  \item \xmlNode{outlier\_label} , \xmlDesc{integer, optional
      field},
  %
...
\begin{itemize}
  \item \xmlNode{n\_neighbors} , \xmlDesc{float, optional
      field},
  %
...
\begin{itemize}
  ...
  %
  \default{None}
  \item \xmlNode{reg\_param} , \xmlDesc{float, optional field},
  %
...
\begin{itemize}
  \item \xmlNode{criterion} , \xmlDesc{string, optional field},
  %
  ...
  %
  \default{gini}
  \item \xmlNode{splitter} , \xmlDesc{string, optional field},
  %
  ...
  %
  \default{best}
  \item \xmlNode{max\_features} , \xmlDesc{int, float or string,
      optional field},
  %
...
\end{itemize}
  ...
  %
  \\\default{None}
  \item \xmlNode{max\_depth} , \xmlDesc{integer, optional
      field},
  %
  ...
  %
  \default{None}
  \item \xmlNode{min\_samples\_split} , \xmlDesc{
      integer, optional field},
  %
  The minimum number of samples required to split an internal node.
  %
  \default{2}
  \item \xmlNode{min\_samples\_leaf} , \xmlDesc{
      integer, optional field},
  %
  The minimum number of samples required to be at a leaf node.
  %
  \default{1}
  \item \xmlNode{max\_leaf\_nodes} , \xmlDesc{
      integer, optional field},
  %
...
the sub-node \xmlNode{SKLtype}\texttt{GaussianProcess|GaussianProcess}\xmlNode{/SKLtype}.
%
In addition to this XML node, several others need (or not) to be inputted:
\begin{itemize}
  \item \xmlNode{regr} , \xmlDesc{string, optional field},
  %
  A regression function returning an array of outputs of the linear regression
  functional basis.
  %
  ...
  %
  \default{constant}
  \item \xmlNode{corr} , \xmlDesc{string, optional field},
  %
  A stationary autocorrelation function returning the autocorrelation between
  two points x and x’.
  %
  Default assumes a squared-exponential autocorrelation model.
  %
  Built-in correlation models are:
  'absolute\_exponential', 'squared\_exponential','generalized\_exponential',
  'cubic', 'linear'.
  %
  \default{squared\_exponential}
  \item \xmlNode{beta0} , \xmlDesc{float, array-like, optional field},
  %
  The regression weight vector to perform Ordinary Kriging (OK).
  %
  \default{Universal Kriging}
  \item \xmlNode{storage\_mode} , \xmlDesc{string, optional
      field},
  %
  A string specifying whether the Cholesky decomposition of the correlation
  matrix should be stored in the class (storage\_mode = ‘full’) or not
  (storage\_mode = ‘light’).
  %
  \default{full}
  \item \verDescriptionA
  \item \xmlNode{theta0} , \xmlDesc{float, array-like, optional field},
  %
  An array with shape (n\_features, ) or (1, ).
  %
  ...
  %
  \default{[1e-1]}
  \item \xmlNode{thetaL} , \xmlDesc{float, array-like, optional field},
  %
  ...
  %
  \default{None}
  \item \xmlNode{thetaU} , \xmlDesc{float, array-like, optional field},
  %
  An array with shape matching theta0’s.
  %
  ...
  %
  \default{None}
  \item \xmlNode{normalize} , \xmlDesc{boolean, optional field},
  %
  Input X and observations y are centered and reduced wrt means and standard
  deviations estimated from the n\_samples observations provided.
  %
  \default{True}
  \item \xmlNode{nugget} , \xmlDesc{float, optional field},
  %
  ...
  \default{10.
    %
    * MACHINE\_EPSILON}
  \item \xmlNode{optimizer} , \xmlDesc{string, optional field},
  %
  ...
  \item \xmlNode{random\_start} , \xmlDesc{integer, optional
      field},
  %
  ...
  %
  \default{1}
  \item \xmlNode{random\_state} , \xmlDesc{integer, optional
      field},
  %
...
the \textbf{\xmlNode{ExternalModel}} input block.
%
...
%
These variables are inputted within consecutive XML blocks called \xmlNode{variable}:
\begin{itemize}
  \item \xmlNode{variable}, string, required parameter.
  %
  ...
  %
\end{itemize}
When the external function variables are defined, at run time, RAVEN initialize
those and take track of their values during the simulation.
%
Each variable defined in the \xmlNode{ExternalModel} block is available in the module
...
detail.
%
\subsubsection{Method: def \_readMoreXML.}
...
call it when the node \xmlNode{ExternalModel} is found parsing XML input file.
%
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textit{delSucLogFiles}, If a simulation (code run) has not failed,
    delete the relative log file (if True)
    \item \textit{deleteOutExtension}, If a simulation (code run) has not
    failed, delete the relative output files with the listed extension (comma
    separated list, for example: 'e,r,txt')
    \item \textit{mode}, Running mode.
    %
    Curently the only modes supported are pbsdsh and mpi
...
%
\skltype{BasicStatistics post-processor}{BasicStatistics}
\begin{itemize}
...
\end{itemize}
  ...
  %
  \item \xmlNode{parameters} , \xmlDesc{comma separated string, required
      field},
  %
  ...
  \xmlNode{Function} node must be present.
  %
  \default{None}
% Assembler Objects
...
%
\begin{itemize}
  	\item \xmlNode{Distribution}: the probability distributions of the ''controllable''
  ...
  attributes that are used to map those within the simulation framework:
    ...
    %
		\end{itemize}
  	\item \xmlNode{controllable}: the list of the controllable variables is given here.
  %
  Each variable is associated with its name and the two items below:
		\begin{itemize}
    			\item \xmlNode{distribution}: the name of the probability distribution
    associated with the controllable variable is specified here.
    %
    			\item \xmlNode{grid}: type, number of steps and tolerance of the sampling grid
    are defined here.
    %
		\end{itemize}
  	\item \xmlNode{non-controllable}: the list of the non-controllable variables is
  given here.
  %
  Each variable is associated with its name and the two items below:
		\begin{itemize}
...
\skltype{LimitSurface}{LimitSurface}
\begin{itemize}
  \item \xmlNode{parameters} , \xmlDesc{comma separated string, required
      field},
  %
  ...
  \item \xmlNode{tollerance} , \xmlDesc{float, optional field},
  %
...
% Assembler Objects
  ...
  following objects' types:
   \begin{itemize}
    \item \xmlNode{ROM}, \xmlDesc{string, optional field},
    %
    If inputted, the body of this xml node must contain the name of a ROM
    defined in the \xmlNode{Models} block (see section \ref{subsec:models_ROM});
    \item \xmlNode{Function}, \xmlDesc{string, required field},The body of
    this xml block needs to contain the name of an External Function defined
    within the \xmlNode{Functions} main block (see section \ref{sec:functions}).
    %
