...
\begin{itemize}
  ...
  %
  \default{0.001}
  \item \xmlNode{n\_alphas}, \xmlDesc{integer, optional field}, the number of
...
\begin{itemize}
  \item \xmlNode{alpha}, \xmlDesc{float, optional field}, constant multiplier
  for the L1 term.
  %
  Defaults to 1.0.
  %
...
path. \maljdan{May need a more better description.}
...
\begin{itemize}
  ...
  which is scaling. \maljdan{Which article?}
  %
  ...
  features. \maljdan{Which article?}
  %
...
\begin{itemize}
  ...
  the features. \maljdan{what article?}
  %
  Should be between 0 and 1.
  %
