...
\newcommand{\resample}[1]{\xmlNode{resample}, \xmlDesc{boolean, optional field}, If True, then recalculate the last optimal point for a new gradient after rejecting the new optimal point. \default{{#1}}.}
