...
\newcommand{\latentVariableDescription}[1]
{
    \begin{itemize}
      \item \xmlNode{latentVariables}, \xmlDesc{comma separated string, optional field}, user-defined 
      latent variables that are used for input reduction.This XML node is required when the user-defined 
      a reduction in the \xmlNode{Distributions} block. The content will specify two attributes:
      \begin{itemize}
        \item \xmlNode{name}, \xmlDesc{string, required field}, the name of distribution that is associated to these variables.
        Its name needs to be contained in the \xmlNode{Distributions} block explained in sectioin 8.
        \item \xmlNode{type}, \xmlDesc{string, required field}, the method that is used for the input reduction.
      \end{itemize}
    \end{itemize}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\latentVariableDescription{MonteCarlo}
