  ...
  \item \assemblerDescription{AdaptiveDynamicEventTree}
    \begin{itemize}
      ...
      \item \xmlNode{TargetEvaluation}, \xmlDesc{string, required field},
        ...
        Section~\ref{sec:DataObjects}).
        %
        The adaptive sampling accepts ``DataObjects'' of
        ``PointSet'' only.
    \end{itemize}
\end{itemize}
...
\end{itemize}
  ...
  \assemblerDescription{Adaptive Sparse Grid}
      ...
      \item \xmlNode{TargetEvaluation}, \xmlDesc{string, required field},
        ...
        Section~\ref{sec:DataObjects}).
        %
        The Adaptive Sparse Grid sampling accepts ``DataObjects'' of
        ``PointSet'' only.
   % \end{itemize}
\end{itemize}
...
\end{itemize}
  ...
  \assemblerDescription{AdaptiveSobol}
      ...
      \item \xmlNode{TargetEvaluation}, \xmlDesc{string, required field},
        ...
        Section~\ref{sec:DataObjects}).
        %
        The Adaptive Sobol sampling accepts ``DataObjects'' of
        ``PointSet'' only.
   % \end{itemize}
\end{itemize}
