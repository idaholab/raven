...
Note that variables that are defined from functions need to be defined outside the samplers of the ensemble sampler. An example is shown below.
In this example note that:
\begin{itemize}
  \item variables $x1$ and $x2$ are generated by the two sampler (Monte-Carlo and Grid respectively)
  \item variable $x3$ is generated by the function $funct1$ 
  \item variables $x4$ and $x5$ are generated by the function $funct2$ 
