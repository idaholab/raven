...
<<<<<<< HEAD
This is possible by defining a \xmlNode{global\_grid} node and associate such \xmlNode{global\_grid} to each variable belonging to the ND distribution as follows.
=======
