...
\newcommand{\xmlDesc}[1] {\textbf{\textit{#1}}}
\newcommand{\xmlString}[1] {\textbf{\texttt{'#1'}}}
...
%
    ...
    \author{%
    \\
     \\\textbf{Cristian Rabiti}
      \textbf{Andrea Alfonsi}
      \\\textbf{Joshua Cogliati}
      \textbf{Diego Mandelli}
      \\\textbf{Robert Kinoshita}
      \textbf{Sonat Sen}
    }
...
%    \end{abstract}
    ...
    \section*{Acknowledgment}
     Thanks to the following people for their contributions in the drawing up of this Manual:
     \begin{itemize}
     \item Ivan Rinaldi;
     \item Alessandro Bandini.
     \end{itemize}
