...
\begin{frame}{Demonstration: Results}
      \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{./attenuate/attenuate_2_mean_errs}
        \caption{Mean, $N=2$}
      \end{figure}
\end{frame}
\begin{frame}{Demonstration: Results}
      \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{./attenuate/attenuate_2_variance_errs}
        \caption{Variance, $N=2$}
      \end{figure}
\end{frame}
...
\begin{frame}{Appendix}
      \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{./attenuate/attenuate_4_mean_errs}
        \caption{Mean, $N=4$}
      \end{figure}
\end{frame}
\begin{frame}{Appendix}
      \begin{figure}
        \centering
        \includegraphics[width=0.8\linewidth]{./attenuate/attenuate_4_variance_errs}
        \caption{Variance, $N=4$}
      \end{figure}
\end{frame}
...
\begin{frame}{Appendix}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{./attenuate/attenuate_6_mean_errs}
    \caption{Mean, $N=6$}
  \end{figure}
\end{frame}
\begin{frame}{Appendix}
  \begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{./attenuate/attenuate_6_variance_errs}
    \caption{Variance, $N=6$}
  \end{figure}
\end{frame}
