...
[Executioner]
  ...
  dt = 5e-2
  time_t = '0         3.0         5.01       9.5     9.75    14      17    60     61.1   350 1.0e5'
  time_dt = '1.e-3  0.005    0.01  2.5e-2    2.5e-2  2.5e-2      2.5e-2    2.5e-3 2.5e-3 5.5e-1  1.5'
  dtmax = 9999
  e_tol = 10.0
  e_max = 99999.
  max_increase = 3
...
[Output]
  # xda = true
  file_base = TMI_test_PRA_transient_less_w
  exodus = true
  output_initial = true
  perf_log = true
  num_restart_files = 1
...
[./frict_m]
data_type = double
initial_value = -505.56
print_csv = true
[../]
[./frict_q]
data_type = double
initial_value = 5005.1
print_csv = true
[../]
  [./scram_start_time]
    data_type = double
