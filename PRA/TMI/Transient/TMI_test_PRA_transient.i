...
[Components]
  ...
  [./CH1]
    ...
    Cp_hs = '288.734 5200.0 321.384'
    rho_hs = '1.0412e4 2.22 6.6e3'
...
[Executioner]
  ...
  restart_file_base = TMI_test_PRA_steady_state_restart_0511
  dt = 5e-2
#  time_t =  '0		5.01	10.01	25.01	50.01'
#  time_dt = '0.1	0.1	0.2	0.5	1.'
  time_t = '0         1.05         5.01       9.5     9.75    14      60   61.05 61.1   75.0  115.0    185.0  5e3'
  time_dt = '8.e-2    0.1          0.05       0.05    0.05    0.05    0.08 0.08  0.005  0.05  2.5e-1   5.0e-1 7.5e-1'
  dtmax = 9999
  e_tol = 10.0
  e_max = 99999.
  max_increase = 2
...
[Output]
  # xda = true
  file_base = TMI_test_PRA_transient
  exodus = true
  output_initial = true
  perf_log = true
...
[Controlled]
  control_logic_input = TMI_test_PRA_trans_control
[./rho_clad_CH1]
print_csv = true
property_name = CLAD:density
data_type = double
component_name = CH1
[../]
[./rho_clad_CH2]
...
[RavenAuxiliary]
  ...
  [./InitialOutletSecPress]
    data_type = double
    print_csv = true
    initial_value = 151.7e5
  [../]
  [./AuxDieselRecoveryTime]
    data_type = double
    print_csv = true
    initial_value = 180
  [../]
