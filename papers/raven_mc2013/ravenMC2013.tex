...
\end{figure}
\\ The analysis of dynamic stochastic systems through Monte-Carlo algorithm can schematized (Figure~\ref{fig:MCsampling}) as following:
\begin{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Subsection{Three miles station black out} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
