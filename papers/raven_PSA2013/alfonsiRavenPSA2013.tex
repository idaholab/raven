...
%RAVEN is now able to perform Dynamic Event Tree analysis through the newly developed module``Raven DET'' (RDET), that has been included in the RAVEN external Python manager.
...
%Indeed, as in similar tools~\cite{ADAPTHakobyan}, the RAVEN/RDET allows the user use different approaches for defying the branching logic:
\vspace{-5mm}
\begin{itemize}
\itemsep0em
