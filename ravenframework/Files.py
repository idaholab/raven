...
class RAVENGenerated(File):
  ...
  def getInputSpecification(cls):
    ...
    """
    spec = InputData.parameterInputFactory('RAVEN', contentType=InputTypes.StringType)
    spec.description = "Internal file generated by RAVEN; not intended for direct user input."
    return spec
...
class CSV(RAVENGenerated):
  ...
  def getInputSpecification(cls):
    """
      ...
      @ Out, inputSpecification, InputData.ParameterInput, class to use for specifying the input of cls.
    """
    spec = InputData.parameterInputFactory('CSV', contentType=InputTypes.StringType)
    spec.description = "Internal CSV file generated by RAVEN; not intended for direct user input."
    return spec
...
class UserGenerated(File):
  ...
  def getInputSpecification(cls):
    """
      ...
      @ Out, inputSpecification, InputData.ParameterInput, class to use for specifying the input of cls.
    """
    spec = InputData.parameterInputFactory('Input', contentType=InputTypes.StringType)
    spec.addParam('type', InputTypes.StringType, descr="File type label for associated code interfaces.")
    spec.addParam('linkedCode', InputTypes.StringType, descr="Linked Code interface name, if applicable.")
    spec.addParam('perturbable', InputTypes.BoolType, descr="Whether this file is perturbable by a sampler.")
    spec.addParam('subDirectory', InputTypes.StringType, descr="Subdirectory relative to the working directory.")
    spec.addParam('name', InputTypes.StringType, descr="Alias for this file entry.")
    return spec
