...
class ARMA(SupervisedLearning):
  ...
  def _trainFourier(self, pivotValues, periods, values, masks=None,target=None):
    ...
    fourierEngine = sklearn.linear_model.LinearRegression()  # scikit-learn >=1.2 removed the normalize kwarg
    ...
    if condNumber  > 30:
      ...
      for fn in range(F2):
        ...
        eng = sklearn.linear_model.LinearRegression()  # scikit-learn >=1.2 removed the normalize kwarg
