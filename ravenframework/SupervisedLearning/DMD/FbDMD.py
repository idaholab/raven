...
class FbDMD(DMDBase):
  """
    Forward/Backward Dynamic Mode Decomposition (Parametric)
  """
  ...
  def getInputSpecification(cls):
    ...
    """
    specs = super(FbDMD, cls).getInputSpecification()
  ...
  def _handleInput(self, paramInput):
    ...
    settings, notFound = paramInput.findNodesAndExtractValues(['svd_rank', 'tlsq_rank','exact', 'opt', 'rescale_mode', 'sorted_eigs'])
