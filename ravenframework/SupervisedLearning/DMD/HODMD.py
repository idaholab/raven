...
class HODMD(DMDBase):
  """
    Higher Order Dynamic Mode Decomposition (Parametric)
  """
  ...
  def getInputSpecification(cls):
    ...
    """
    specs = super(HODMD, cls).getInputSpecification()

    specs.description = r"""The \xmlString{HODMD} ROM aimed to construct a time-dependent (or any other monotonic
    variable) surrogate model based on the High Order Dynamic Mode Decomposition
    ...
    \begin{itemize}
      ...
      \item \xmlNode{svd\_rank\_extra}, see XML input specifications below
