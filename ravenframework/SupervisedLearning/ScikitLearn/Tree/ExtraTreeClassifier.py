...
class ExtraTreeClassifier(ScikitLearnBase):
  """
    ExtraTreeClassifier
    An extremely randomized tree classifier.
  """
  ...
  def getInputSpecification(cls):
    ...
    """
    specs = super(ExtraTreeClassifier, cls).getInputSpecification()
    specs.description = r"""The \xmlNode{ExtraTreeClassifier} is an ``extremely randomized tree classifier''.
