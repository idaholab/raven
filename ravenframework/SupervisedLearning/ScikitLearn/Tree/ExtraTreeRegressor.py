...
class ExtraTreeRegressor(ScikitLearnBase):
  ...
  def getInputSpecification(cls):
    ...
    specs.description = r"""The \xmlNode{ExtraTreeRegressor} is extremely randomized tree regressor.
                         ...
                         """
    specs.addSub(InputData.parameterInputFactory("criterion", contentType=InputTypes.makeEnumType("criterion", "criterionType",['squared_error','friedman_mse','absolute_error']),
                                                 ...
                                                 ``absolute\_error'' (formerly ``mae'') for the mean absolute error, which minimizes the L1 loss using the median of each terminal node.""", default='squared_error'))
