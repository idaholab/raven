...
class KNeighborsRegressor(ScikitLearnBase):
  """
    KNeighborsRegressor
    Regressor implementing the k-nearest neighbors vote.
  """
  ...
  def getInputSpecification(cls):
    ...
    """
    specs = super(KNeighborsRegressor, cls).getInputSpecification()
    specs.description = r"""The \xmlNode{KNeighborsRegressor} is a type of instance-based learning or
